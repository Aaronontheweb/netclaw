...
| Skill Auto-Loading | 5 | Keyword matching triggers correct skills, including identity and mission authoring guidance |
...
| Subagents | 2 | Delegates through `spawn_agent`, completes ambiguous work, and applies the inherited deployment playbook |
