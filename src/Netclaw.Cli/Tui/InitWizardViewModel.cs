...
public partial class InitWizardViewModel : ReactiveViewModel
{
    ...
    public InitWizardViewModel(
        ...
        : this(paths, registry, registry, slackProbe, discordProbe,
            ...
            clipboardService: clipboardService, sectionEditors: sectionEditors)
    {
    }
        ...
        SectionEditorRegistry? sectionEditors = null)
    {
        ...
        // provider -> security-posture -> feature-selection -> channel-picker -> channels -> search -> browser-automation -> identity -> external-skills -> health-check
